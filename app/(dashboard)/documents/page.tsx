      ...
      <main className="flex-1 overflow-y-auto">
        <div className="mx-auto max-w-7xl p-4 lg:p-8">
          ...
          <Card
            ...
            className={`relative border-2 transition-all duration-200 ${isDragOverZone && !draggedItem
                ...
                >
                  {rootDocuments.map((doc) => (
                    <div
                      ...
                      onDragEnd={handleDragEnd}
                      className={`group relative rounded-xl border-2 transition-all duration-200 ${viewMode === "grid"
                    ...
                    >
                      <div
                        ...
                        className={`flex flex-1 items-center gap-4 cursor-pointer p-4 ${viewMode === "list" ? "flex-1" : ""
                          }`}
                      >
                        <div
                          className={`flex-shrink-0 rounded-lg p-3 ${doc.type === "folder"
